...
class Breadcrumbs {
	...
	public function register_hooks() {
		add_action( 'cambridge_coaching_breadcrumbs', array( $this, 'display_breadcrumbs' ) );
	}
	...
	function display_breadcrumbs() {
		...
		$this->_display_breadcrumb_item( __( 'Home', 'cambridge-coaching' ), get_home_url(), false, 'breadcrumb-home' );

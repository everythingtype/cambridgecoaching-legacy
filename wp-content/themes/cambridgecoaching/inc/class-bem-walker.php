<?php
/**
 * Converts the Menu markup to use nicer BEM class names for styling, instead of the WordPress default menu items.
 *
 * Modified from https://codepad.co/snippet/xzEkTh25
 */
